...
{
    public class NarrativePointAudioDataContainerView
    {
        private readonly NarrativePointAudioDataContainer _instance;
        private GUIStyle _boxStyle;
        private GUIStyle _blockHeaderStyle;
        private GUIStyle _headerTextStyle;
        private bool _inspectorStylesInitialized = false;
        
        public NarrativePointAudioDataContainerView(NarrativePointAudioDataContainer instance)
        {
            _instance = instance;
        }
        ...
        protected void DrawMoodID(int id)
        {
            EditorGUILayout.BeginHorizontal();
            EditorGUILayout.LabelField($"Mood ID : {id}", _boxStyle);
