...
{
    public class IntParameterConditionView : BaseConditionView
    {
        protected IntParameterCondition Instance;
        
        protected GUIStyle CountertextStyle;

        public IntParameterConditionView(IntParameterCondition instance)
        {
            Instance = instance;
        }
        ...
        protected override void ShowCharacterMoreData(Character targetCharacter)
        {
            ...
            foreach (var x in targetCharacter.Parameters)
            {
                ...
                if (x.GetType() != typeof(IntParameter)) continue;
        ...
        protected void DrawFieldBlock()
        {
            ...
            if (Instance.parameter is null)
            {
                ...
                Instance.parameter = EditorGUILayout.ObjectField(Instance.parameter, typeof(IntParameter), false,
                    GUILayout.MaxWidth(200), GUILayout.MinWidth(20), GUILayout.Height(24)) as IntParameter;
                GUILayout.FlexibleSpace();
